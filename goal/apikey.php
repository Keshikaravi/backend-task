	...
	<nav class="vertical_nav">
		<div class="left_section menu_left" id="js-menu" >
			...
			<ul>
					...
					<li class="menu--item">
						<a href="live_streams.html" class="menu--link" >
	...
	<div class="wrapper">
		<div class="sa4d25">
			<div class="container">			
				<div class="row">
					<div class="col-lg-12">	
						<h2 class="st_title"><i class="uil uil-analysis"></i> Add Key</h2>
					</div>					
				</div>				
						...
						<div class="course_tabs_1">
							<div id="add-course-tab" class="step-app">
								...
								<div class="step-content">
												...
												<div class="general_info10">
													...
													<div class="row">
														<div class="col-lg-6 col-md-6">															
															<div class="ui search focus mt-30 lbel25">
																...
																<div class="ui left icon input swdh19">
																	<input class="prompt srch_explore" type="text" placeholder="Key Name" name="keyname"  maxlength="60" id="main[title]" value="">															
																</div>
															</div>									
														</div>
														<div class="col-lg-6 col-md-6">															
															<div class="ui search focus mt-30 lbel25">
																<label>Key</label>
																<div class="ui left icon input swdh19">
																	<input class="prompt srch_explore" type="text" placeholder="Key" name="key">															
																</div>
															</div>									
														</div>
														<div class="col-lg-6 col-md-6" hidden>															
															<div class="ui search focus mt-30 lbel25">
																<div class="ui left icon input swdh19">
																	<input class="prompt srch_explore" type="text" placeholder="Key" name="stat" value="inactive">															
																</div>
															</div>									
														</div>
														<div class="col-lg-6 col-md-6" hidden>															
															<div class="ui search focus mt-30 lbel25">
																<div class="ui left icon input swdh19">
																	<input class="prompt srch_explore" type="text" placeholder="Key" name="usrid" value="<?php echo $username; ?>" >															
																</div>
															</div>									
														</div>
									...
									<button data-direction="finish" type=submit name="submit" class="btn btn-default steps_btn" style="margin-top:2%;float:right">Submit</button>
